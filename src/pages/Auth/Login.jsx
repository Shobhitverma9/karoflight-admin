...
// ----------------------------------------------------------------------------------
const Login = () => {
  const { isLoading, isUserLoggedIn, errorMessage, user } = useSelector(
    (state) => state.auth
  );
  ...
  // Re-check role whenever login status changes
  useEffect(() => {
    if (isUserLoggedIn) {
  ...
  }, [isUserLoggedIn]); // Add dependency on isUserLoggedIn

  // Memoized function to toggle password visibility
  ...
  const getDashboardRoute = (role) => {
    ...
    console.log("Routing for role:", normalizedRole);
      ...
      <div className="flex flex-wrap h-screen justify-center items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            <p className="text-2xl">Welcome to the AirMBM Admin Panel</p>
        ...
        <div className="w-full border-stroke xl:w-1/2 xl:border-l-2 mb-14">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            <div className="text-center mb-8">
              <img
                className="h-16 rounded mx-auto mb-4"
                src={logo}
                alt="AirMBM Logo"
              />
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none transition-colors ${
              ...
              <div className="mb-8">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-12 outline-none focus:border-primary focus-visible:shadow-none transition-colors ${
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    {showPassword ? (
                      <svg
                        className="w-6 h-6"
              ...
              <div className="mb-6">
                <button
                  ...
                  className="w-full inline-flex items-center justify-center rounded-md bg-[#222A59] hover:bg-blue-950 disabled:bg-gray-400 disabled:cursor-not-allowed px-3.5 py-3.5 font-semibold leading-7 text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#222A59] focus:ring-offset-2"
                >
                  {isLoading ? (
                    <>
